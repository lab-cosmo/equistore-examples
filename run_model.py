...
frames1 = ase.io.read("data/ethanol-hamiltonian/ethanol_4500.xyz",":200")
...
features = hamiltonian_features(rho3i, rho2ij)
...
torch.save(testham_msefull.state_dict(), "./models/mseful.pt")
...
torch.save(testham_eigval.state_dict(), "./models/eigval.pt")
...
#torch.save(testham_indiv.state_dict(), "./models/indiv_models.pt")
testham_indiv.load_state_dict(torch.load("./models/indiv_models.pt"))

# ## Evaluation

#Load test set
#test_frames1 = ase.io.read("data/water-hamiltonian/water_coords_1000.xyz","900:1000")
...
#test_focks1 = np.load("data/water-hamiltonian/water_saph_orthogonal.npy", allow_pickle=True)[900:1000]
...
test_rho2i = cg_increment(test_rho1i, test_rho1i, lcut=4, other_keys_match=["species_center"], clebsch_gordan=cg)
test_rho1ij = cg_increment(test_rho1i, test_gij, lcut=4, other_keys_match=["species_center"], clebsch_gordan=cg)

test_rho3i = cg_increment(test_rho2i, test_rho1i, lcut=2, other_keys_match=["species_center"], clebsch_gordan=cg)
rho2ij = cg_increment(test_rho2i, test_gij, lcut=2, other_keys_match=["species_center"], clebsch_gordan=cg)

test_features = hamiltonian_features(test_rho3i, test_rho2ij)
