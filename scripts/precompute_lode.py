...
def main():
    ...
    parser.add_argument("-index",
                        ...
                        default=":")
    parser.add_argument("-max_radial",
                        dest="max_radial",
                        type=int,
    ...
    parser.add_argument("-max_angular",
                        ...
                        default=6)
    parser.add_argument("-cutoff_radius",
                        dest="cutoff_radius",
                        type=float,
    ...
    parser.add_argument("-potential_exponent",
    ...
    parser.add_argument('-subtract_center_contribution',
    ...
    frames = ase.io.read(args.__dict__.pop("input_file"),
                         index=args.__dict__.pop("index"))
    write(args.__dict__.pop("outfile"),
